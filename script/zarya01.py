...
MESSAGES = [
    ...
    [
        ...
        '*происходит проверка каналов связи: ДЭМШ и КВ. Команды дают друг другу отсчёт, '
        'пока настраиваются каналы. Всё это время играет музыка: Заветный перекрёсток*',
    ...
    [
        ...
        '*отсчет для проверки канала связи КВ и проверка положения тумблера*',
        '*через 1 минуту*,'
        # in 1 min

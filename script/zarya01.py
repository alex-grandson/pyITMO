...
MESSAGES = [
    ...
    [
        ...
        '*в течении двух минут Руднев справлялся о самочувствии Юрия и делился новостями*',
        # через 2 минуты
    ...
    [
        ...
        '*далее Юрий дает отсчет для проверки канала связи КВ. А далее в течении двух минут происходит проверка положения тумблера*',
        # in 1 min
    ...
    [
        ...
        '*в течении трёх минут проиходила настройк связи с разной аппаратуры и проверка каналов с Быковым. Быков справлялся о самочувствии Юрия*',
